...
<body>
	...
	<div class="shadow-lg p-3 bg-body-tertiary rounded  row" >
<form method="post" id="form1" action="/login">
<div class="container mt-3 shadow-lg mb-3" >
  <img class="mt-2 ml-5" style="max-block-size: 3cm;padding-left:2cm" src="bmtc4.png">
    <h1 style="text-align: center;">ಲಾಗಿನ್ </h1>
    <!-- <h1 style="text-align: center;">Login Form</h1> -->
      <div class="form-check" >
     <input type="radio" class="form-check-input" id="radio1" name="login_type" value="Controller" checked>ನಿರ್ವಾಹಕರು 
     <label class="form-check-label" for="radio1"></label>
   </div>
   <div class="form-check">
     <input type="radio" class="form-check-input" id="radio2" name="login_type" value="Passenger">ಪ್ರಯಾಣಿಕರು 
     <label class="form-check-label" for="radio2"></label>
   </div>
   
     <form class="form-floating mt-5 mb-5" method="post">
      <div class="form-floating mt-3 mb-3">
        <label for="usr">ದೂರವಾಣಿ ಸಂಖ್ಯೆ ನಮೂದಿಸಿ</label>
     <input type="text" class="form-control" id="usr" style="width: 10cm;" name="mobile" placeholder="ದೂರವಾಣಿ ಸಂಖ್ಯೆ ನಮೂದಿಸಿ"  required>
     
   </div>
   
    <div class="form-floating mt-3 mb-3">
        <label for="pwd">ಪಾಸ್ವರ್ಡ್ ನಮೂದಿಸಿ </label>
     <input  type="password" class="form-control" id="pwd" name="password" placeholder="ಪಾಸ್ವರ್ಡ್ ನಮೂದಿಸಿ" style="width: 10cm;"  required>
     <input type="checkbox" class="form-check-label mt-2" onclick="myFunction()"> ಪಾಸ್ವರ್ಡ್ ತೋರಿಸು 

   </div>
   
       
       <button type="submit" class="btn btn-primary mb-3" style="width: 10cm;">ಲಾಗಿನ್ </button>
     </form>
     <!-- <h6 style="text-align: center;">Note: If Login Is not working click on logout then try again</h6> -->
   </div>
   </form>
